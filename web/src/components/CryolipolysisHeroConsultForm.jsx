...
/** Compact consultation form for weight-loss service hero banners; POSTs to /api/weight-loss. */
export default function CryolipolysisHeroConsultForm({
  sourcePage = 'cryolipolysis',
  treatmentValue = 'cryolipolysis',
  treatmentLabel = 'Cryolipolysis',
}) {
  const formId = useId()
      ...
      <form id={formId} className="cryolipolysis-hero-form" onSubmit={onSubmit} noValidate>
        ...
        <div className="cryolipolysis-hero-form__row cryolipolysis-hero-form__row--split">
          ...
          <label className="cryolipolysis-hero-form__field">
            ...
            >
              <option value={treatmentValue}>{treatmentLabel}</option>
            </select>
          </label>
        </div>
